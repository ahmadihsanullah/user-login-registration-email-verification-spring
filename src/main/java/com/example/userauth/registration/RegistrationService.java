...
import com.example.userauth.appuser.service.AppUserService;
...
//        2. sign up
        ...
        String link = "http://localhost:8080/api/v1/registration/confirm?token=" + token; // manggil controller confirm Token
